package com.solverminds.klsm.config;
...
import com.solverminds.klsm.util.WebConstants;

@Configuration
@EnableWebMvc
@ComponentScan({ "com.solverminds.klsm" })
public class WebMvcConfig extends WebMvcConfigurerAdapter
{
	...
	/*
	 * @Bean public RiskAssessmentDataService riskAssessmanetDataService() { RiskAssessmentDataService riskAssessmanetDataService = new
	 * RiskAssessmentDataService(); return riskAssessmanetDataService; }
	 */
}
