...
function chartistLineChart(element) {
    ...
    for (var i = 0; i < points; i++) {
		...
		seriesC.push(getRandomInt(20, 90));
		seriesD.push(getRandomInt(20, 90));
    }
    var data = {
        labels: labels,
        series: []
	...
	data.series.push(seriesC);
	data.series.push(seriesD);
...
function chartJsBarChart(element, colors, palette) {
    ...
    var barChartData = {
        labels: ["Challenge Premier", "Rainbow Star", "Tenryu Maru", "World Navigator", "Pacific Vega"],
        datasets: [{
